...
def inference(imgs_scene,sobel,morph_conv):
    ...
    img_colorcode_pred = (crop_imgs_colorcode_pred[0,:,:,:]+1)/2
...
if __name__ == '__main__':
    ...
    model_seg.load_state_dict(torch.load("inference files/seg.pth"))
    model_cc.load_state_dict(torch.load("inference files/cc.pth"))
    model_seg.eval()
    model_cc.eval()
